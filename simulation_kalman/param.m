...
P.Q_opponent = 1*diag([.001^2, .001^1, .01^2, 0.1^1, 0.1^2, 0.1^2, 1^2,1^2,(2*pi/180)^2]);
P.R_opponent = diag([P.camera_sigma_robot_position^2; P.camera_sigma_robot_position^2; P.camera_sigma_robot_angle^2]);
P.Q_ball = 1*diag([.001^2,.001^2,.01^2,.01^2, .1^2, .1^2, 10^2, 10^2]);
